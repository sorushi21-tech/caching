...
public class ExchangeRateController {
  ...
  @GetMapping("/rate")
  public RateResponse getRate(@RequestParam String from, @RequestParam String to) {
    ...
    try {
      ...
      return new RateResponse(from.toUpperCase(Locale.ROOT), to.toUpperCase(Locale.ROOT), rate);
