...
import com.caching.transaction_service_caffeine_cache.dto.CategoryCurrencyTotalResult;
...
public class TransactionSummaryRepositoryImpl implements TransactionSummaryRepository {
  ...
  public List<CategoryCurrencyTotalProjection> findCategoryCurrencyTotals() {
    ...
    List<CategoryCurrencyTotalProjection> mappedResults =
        new ArrayList<>(results.getMappedResults());
